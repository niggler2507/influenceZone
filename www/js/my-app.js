...
$$(document).on('page:init', '.page[data-name="mapa"]', function (e) {
  ...
  function addInfoBubble(map) {
    ...
    addMarkerToGroup(group, { lat: -34.637941, lng: -58.637422 },
      ...
      '<a href="/ong2/" data-view=".page-content" class="col button button-raised button-round button-fill"><em>INFLUENCE</em></a>');
  }
  addInfoBubble(map);
...
$$(document).on('page:init', '.page[data-name="ong"]', function (e) {
  mostrar("pantalla del perfil de Ong");
...
//    PERFIL DE LA ONG2
//////////////////////////////////////////////////////////////////////////////////////////
$$(document).on('page:init', '.page[data-name="ong2"]', function (e) {
  mostrar("pantalla del perfil de Ong2");

  /*=== With Video ===*/
  var myVideoBrowserPopupDark = app.photoBrowser.create({
    photos: [
      {
        html: '<iframe src="../videos/video02.mp4" frameborder="0" allowfullscreen></iframe>',
        caption: 'Video que muestra la zona en donde trabaja la Ong'
      },
    ],
    theme: 'dark',
  ...
  var myPhotoBrowserPopupDark = app.photoBrowser.create({
    photos: [
      'img/hogarEjemplo02/01.jpg',
      'img/hogarEjemplo02/02.jpg',
      'img/hogarEjemplo02/03.jpg',
      'img/hogarEjemplo02/04.jpg',
      'img/hogarEjemplo02/05.jpg',
      'img/hogarEjemplo02/06.jpg',
      'img/hogarEjemplo02/07.jpg',
    ],
    theme: 'dark',
    type: 'popup'
  });
